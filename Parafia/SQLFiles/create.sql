...
('Ima','Kirkland','F'	 , true, '2014-11-17', NULL, 141 ,NULL, NULL),
('Yvette','Hart','F'	 , true, '2011-11-04', 488, 232 ,NULL, NULL),
('Sloane','Larsen','F'	 , true, '2014-02-03', 342, 299 ,NULL, NULL),
('Kristen','Whitfield','F'	 , true, '2018-07-07', NULL, NULL ,NULL, NULL),
('Myra','Dodson','F'	 , false, '2009-07-28', 353, 138 ,NULL, NULL),
('Xandra','Duran','F'	 , true, '2008-05-04', NULL, 122 ,NULL, NULL),
('Michael','Bowman','M'	 , true, '2013-07-04', NULL, NULL ,NULL, NULL),
('Lane','Wagner','M'	 , true, '2003-08-23', 334, 152 ,NULL, NULL),
('Robert','Cardenas','M'	 , true, '2009-08-15', 388, NULL ,NULL, NULL),
('Myles','Wooten','M'	 , true, '2007-04-06', 473, NULL ,NULL, NULL),
('Abbot','Harrington','M'	 , true, '2018-02-22', NULL, 158 ,NULL, NULL),
('Judah','Norman','M'	 , true, '2000-10-27', NULL, NULL ,NULL, NULL),
('Cain','Landry','M'	 , true, '2003-07-06', NULL, 254 ,NULL, NULL),
('Samuel','Merrill','M'	 , true, '2009-06-17', NULL, 143 ,NULL, NULL),
('Armando','Jacobson','M'	 , true, '2008-09-22', 492, 276 ,NULL, NULL),
('Adam','Stanley','M'	 , true, '2015-09-17', 461, NULL ,NULL, NULL),
('Marshall','Hobbs','M'	 , true, '2019-02-05', NULL, 142 ,NULL, NULL),
('Dolan','Massey','M'	 , true, '2011-07-12', 406, 278 ,NULL, NULL),
('Dolan','Juarez','M'	 , true, '2002-09-16', 312, 230 ,NULL, NULL),
('Tanner','Hart','M'	 , true, '2005-02-01', 446, 251 ,NULL, NULL),
('Tobias','Carpenter','M'	 , true, '2004-03-06', 381, NULL ,NULL, NULL),
('Cairo','Garrison','M'	 , true, '2014-05-02', NULL, NULL ,NULL, NULL),
('Brett','Gonzalez','M'	 , true, '2007-04-06', NULL, 131 ,NULL, NULL),
('Solomon','Grant','M'	 , true, '2015-09-21', 482, 285 ,NULL, NULL),
('Byron','Gonzalez','M'	 , true, '2002-06-24', NULL, 197 ,NULL, NULL),
('William','Herring','M'	 , true, '2018-07-13', 363, 232 ,NULL, NULL),
('Chadwick','Donovan','M'	 , true, '2003-12-09', 394, 223 ,NULL, NULL),
('Rooney','Freeman','M'	 , true, '2017-10-04', 471, NULL ,NULL, NULL),
('William','Beck','M'	 , true, '2014-03-07', NULL, NULL ,NULL, NULL),
('Castor','Joseph','M'	 , true, '2004-06-08', 453, 147 ,NULL, NULL),
('Denton','Cash','M'	 , true, '2012-01-18', 305, 145 ,NULL, NULL),
('Aristotle','Reeves','M'	 , true, '2002-02-04', NULL, NULL ,NULL, NULL),
('Denton','Dickson','M'	 , true, '2016-05-17', 380, 278 ,NULL, NULL),
('Sylvester','French','M'	 , true, '2015-11-04', NULL, 150 ,NULL, NULL),
('Price','Nicholson','M'	 , true, '2013-05-23', 422, 116 ,NULL, NULL),
('Sawyer','Warner','M'	 , true, '2000-07-27', 407, 146 ,NULL, NULL),
('Vladimir','Holden','M'	 , true, '2013-08-12', NULL, 164 ,NULL, NULL),
('Laith','Bright','M'	 , true, '2008-04-20', 417, NULL ,NULL, NULL),
('Abel','Cotton','M'	 , true, '2019-10-17', 330, NULL ,NULL, NULL),
('Caleb','Webster','M'	 , true, '2001-12-01', 302, 205 ,NULL, NULL),
('Silas','Baker','M'	 , true, '2016-09-12', 458, NULL ,NULL, NULL),
('Ezra','Callahan','M'	 , true, '2019-07-19', 302, 100 ,NULL, NULL),
('Bert','Griffith','M'	 , true, '2005-07-14', 411, 107 ,NULL, NULL),
('Garrett','Porter','M'	 , true, '2019-05-07', NULL, NULL ,NULL, NULL),
('Randall','Hughes','M'	 , true, '2006-07-13', 421, 281 ,NULL, NULL),
('Leroy','Hardin','M'	 , true, '2003-11-18', NULL, 274 ,NULL, NULL),
('Micah','Avery','M'	 , true, '2001-10-20', NULL, NULL ,NULL, NULL),
('Rigel','Burch','M'	 , true, '2015-11-02', NULL, 150 ,NULL, NULL),
('Driscoll','Torres','M'	 , true, '2004-09-08', NULL, NULL ,NULL, NULL),
('Ryan','Guzman','M'	 , true, '2014-02-03', NULL, 207 ,NULL, NULL),
('Rajah','Nash','M'	 , true, '2012-10-15', 312, 199 ,NULL, NULL),
('Donovan','Bowers','M'	 , true, '2007-05-10', NULL, 185 ,NULL, NULL),
('Rogan','Orr','M'	 , true, '2018-08-11', 437, NULL ,NULL, NULL),
('Eaton','Holland','M'	 , true, '2010-07-07', 456, 109 ,NULL, NULL),
('Cameron','Aguirre','M'	 , true, '2013-12-19', 484, NULL ,NULL, NULL),
('Oren','Paul','M'	 , true, '2008-09-11', NULL, 211 ,NULL, NULL),
('Luke','James','M'	 , true, '2018-07-24', NULL, 233 ,NULL, NULL),
('Oleg','Kim','M'	 , false, '2013-01-20', 486, 167 ,NULL, NULL),
('Eagan','Gaines','M'	 , true, '2013-09-28', 356, NULL ,NULL, NULL),
('Keane','Glenn','M'	 , true, '2019-02-12', 342, NULL ,NULL, NULL),
('Cooper','Stevenson','M'	 , true, '2011-05-04', 461, NULL ,NULL, NULL),
('Austin','Cruz','M'	 , true, '2007-11-24', 412, 177 ,NULL, NULL),
('Daquan','Richards','M'	 , true, '2008-08-12', 328, 152 ,NULL, NULL),
('Logan','Meadows','M'	 , true, '2016-08-11', 316, 289 ,NULL, NULL),
('Cody','Dunn','M'	 , false, '2006-08-12', 418, 141 ,NULL, NULL),
('Allen','Peterson','M'	 , true, '2019-06-28', 383, 109 ,NULL, NULL),
('Keegan','Merrill','M'	 , true, '2011-04-01', 461, 145 ,NULL, NULL),
('Nero','Madden','M'	 , true, '2004-10-06', 450, 225 ,NULL, NULL),
('Grant','Newton','M'	 , true, '2007-07-19', 413, 292 ,NULL, NULL),
('Talon','Fernandez','M'	 , true, '2000-02-21', NULL, NULL ,NULL, NULL),
('Erich','Galloway','M'	 , true, '2017-08-04', 320, 295 ,NULL, NULL),
('Dale','Warner','M'	 , true, '2016-02-06', NULL, 138 ,NULL, NULL),
('Blaze','Mccormick','M'	 , true, '2014-08-12', 382, 169 ,NULL, NULL),
('Herman','Wallace','M'	 , true, '2008-01-13', 430, 217 ,NULL, NULL),
('Allen','Walker','M'	 , true, '2008-11-26', 485, NULL ,NULL, NULL),
('Rogan','Hinton','M'	 , true, '2014-05-27', 386, NULL ,NULL, NULL),
('Tucker','Booth','M'	 , true, '2014-12-03', 442, 159 ,NULL, NULL),
('Edward','Estes','M'	 , false, '2002-02-16', 454, NULL ,NULL, NULL),
('Jared','Mosley','M'	 , true, '2014-08-18', 485, 138 ,NULL, NULL),
('Tobias','Blackburn','M'	 , true, '2011-08-10', NULL, NULL ,NULL, NULL),
('Aaron','Tucker','M'	 , true, '2004-08-10', NULL, NULL ,NULL, NULL),
('Jonas','Fitzgerald','M'	 , true, '2013-02-03', 336, 149 ,NULL, NULL),
('Talon','Washington','M'	 , true, '2009-02-22', NULL, 122 ,NULL, NULL),
('Ronan','Valdez','M'	 , true, '2007-06-11', 425, 282 ,NULL, NULL),
('Amal','Dean','M'	 , true, '2016-08-11', NULL, 124 ,NULL, NULL),
('Timon','Myers','M'	 , true, '2019-08-09', 388, 189 ,NULL, NULL),
('Armand','Dunn','M'	 , true, '2017-02-01', 446, 198 ,NULL, NULL),
('Samson','Cooke','M'	 , true, '2012-01-01', 412, 159 ,NULL, NULL),
('Raja','Waters','M'	 , true, '2009-09-04', NULL, NULL ,NULL, NULL),
('Jerry','Walls','M'	 , true, '2011-05-22', 416, 123 ,NULL, NULL),
('Palmer','Herring','M'	 , true, '2018-03-17', 434, 260 ,NULL, NULL),
('Logan','Moran','M'	 , true, '2010-03-05', NULL, 273 ,NULL, NULL),
('Vladimir','Roberson','M'	 , true, '2005-01-24', NULL, 156 ,NULL, NULL),
('Guy','Schultz','M'	 , true, '2008-10-15', NULL, 238 ,NULL, NULL),
('Xander','Henderson','M'	 , true, '2019-03-01', 356, NULL ,NULL, NULL),
('Uriah','Mcmahon','M'	 , true, '2011-02-07', NULL, 125 ,NULL, NULL),
('Hashim','Nicholson','M'	 , true, '2008-03-24', 323, 190 ,NULL, NULL),
('Lewis','Burch','M'	 , true, '2012-02-24', 445, 245 ,NULL, NULL),
('Ali','Levy','M'	 , true, '2009-07-03', 329, NULL ,NULL, NULL),
...
('Scott','Bullock','M'	 , true, '2012-02-28', 345, 181 ,NULL, NULL),
('Jesse','Cunningham','M'	 , true, '2012-08-25', NULL, NULL ,NULL, NULL),
('Ryder','Oliver','M'	 , true, '2003-08-16', 368, 148 ,NULL, NULL),
